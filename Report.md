...
![Deep Q-Learning algorithm from Udacity course](./algorithm1.png)
...
![Training logs](./train_result.png)


The agent reach the goal +13 in 600 Episode,and reach the +16 in 1007 episode.
...
> Researchers at Google DeepMind recently tested the performance of an agent that incorporated all six of these modifications{1.Double DQN (DDQN), 2.Prioritized experience replay, 3.Dueling DQN, 4.[A3C](https://arxiv.org/abs/1602.01783), 5.[Distributional DQN](https://arxiv.org/abs/1707.06887), 6.[Noisy DQN](https://arxiv.org/abs/1706.10295)}. The corresponding algorithm was termed Rainbow.It outperforms each of the individual modifications and achieves state-of-the-art performance on Atari 2600 games!

### Performance 
Test agent in local machine.

#### Image
Snapshot of agent test in local machine.
![test_local.png](./test_local.png)

#### Video
[Video record youtube link](https://youtu.be/FhjE072F3x0)
